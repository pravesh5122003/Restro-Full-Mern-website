...
const Cart = () => {
  ...
  const placeOrder = async () => {
   ...
   const placeDineInOrder = async () => {
    if (!tableNo || !phoneNo) {
      return toast.error("Please enter table number and phone number");
    }
  
    try {
      const { data } = await axios.post("/api/order/dinein", {
        userId: user._id,
        items: cartArray.map((item) => ({
          product: item._id,
          quantity: item.quantity,
  ...
  return products.length > 0 && cartItems ? (
    <div className="flex flex-col md:flex-row py-16 max-w-6xl w-full px-6 mx-auto">
      <div className="flex-1 max-w-4xl">
        ...
        <div className="grid grid-cols-[2fr_1fr_1fr] text-gray-500 text-base 
        font-medium pb-3">
        ...
        {cartArray.map((product, index) => (
          <div
            key={index}
            className="grid grid-cols-[2fr_1fr_1fr] text-gray-500 items-center
      ...
      <div className="max-w-[360px] w-full bg-gray-100/40 p-5 max-md:mt-16 border border-gray-300/70">
        ...
        <div className="mb-6">
          ...
          <select
            ...
            className="w-full border border-gray-300 bg-white px-3 py-2 mt-2
             outline-none"
          >
...
>
  ...
  <div className="fixed inset-0 z-50 bg-black/40 flex items-center justify-center">
    <div className="bg-white p-6 rounded-lg shadow-xl w-full max-w-md">
      <h2 className="text-xl font-semibold mb-4">Dine In Order</h2>
