...
const MyOrders = () => {
  ...
  return (
    <div className="pt-20 pb-16 px-4"> {/* or 'mt-12 pt-8' if your navbar is smaller */}
            ...
            >
              <div className="flex items-center mb-4 md:mb-0">
                <div className="p-4 rounded-lg">
                  <img
                    src={`http://localhost:4000/images/${item.product.image[0]}`}
                    alt=""
                    className="w-16 h-16"
                  />
                </div>
              ...
              <p>
               Total Amount:₹{item.product.offerPrice * item.quantity}
              </p>
              </div>
            </div>
          ))}
